#!/bin/bash
#
# Script to generate application traffic through firewall-a vwire.
#
# The script uses tcpreplay to run several pcap files through the vwire on firewall-a.
# The script also uploads user-id information using the XML API to the firewall.
#
# Version 04.30.2020a
# Bill Claunch
# Palo Alto Networks
...
# echo "UserID1.sh script completed at "$(date) >> /home/paloalto42/pcaps82019/Script.Ran.txt
echo "Done."
starttime=$SECONDS
