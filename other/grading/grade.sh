...
echo ""
sleep 1
curl -kG "https://192.168.1.254/api/?type=export&category=configuration&key=LUFRPT1aMHN0MHk5UnVvWEYvcVYxdnhLU3BaM1RBdU09M0NCZkhWTFhSK3lmaTk4SEc3bXE0U2NoRWVrL2VpZ2FiK3d3bHkwMCtCTT0=" > running-config.xml
...
mv *xml /home/paloalto42/grading/MyLabScores/
###########
# To Do
#
